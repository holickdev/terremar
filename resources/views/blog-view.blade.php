...
<section class="pt-8 lg:pt-16 lg:pb-24 bg-white dark:bg-gray-900 antialiased">
  <div class="flex justify-between px-4 mx-auto max-w-screen-xl ">
      <article class="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
            <section class="mb-4 lg:mb-6 not-format">
                <address class="flex items-center mb-6 not-italic">
                    <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                        <img class="mr-4 w-16 h-16 rounded-full" src="{{ asset('storage/'. $blog->blogger->picture) ?? '' }}" alt="Autor-Picture">
                        <div>
                            <a href="#" rel="author" class="text-xl font-bold text-gray-900 dark:text-white">{{$blog->blogger->person->name}} {{$blog->blogger->person->lastname}}</a>
...
<aside aria-label="Related articles" class="py-8 lg:py-24 bg-gray-50 dark:bg-gray-800">
  <div class="px-4 mx-auto max-w-screen-xl">
      ...
      <div class="justify-center grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
        @foreach ( $related as $relate)
          <article class="max-w-xs">
              ...
              <p class="mb-4 text-gray-500 dark:text-gray-400">{{$relate->description}}</p>
