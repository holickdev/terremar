        ...
        <form method="POST" action="{{ route('update_profile', $profile->id) }}">
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                ...
                <div class="sm:col-span-2">
                    <label for="identification" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Cédula</label>
                ...
                <div>
                    ...
                    <select name="gender" id="gender"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                        <option value="value1" {{ $profile->person->gender == 'value1' ? 'selected' : '' }}>Masculino</option>
                        <option value="value2" {{ $profile->person->gender == 'value2' ? 'selected' : '' }}>Femenino</option>
                        <option value="value3" {{ $profile->person->gender == 'value3' ? 'selected' : '' }}>Otros</option>
                    </select>
                </div>
            </div>

            <div class="flex items-center space-x-4">
                <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                    Actualizar Asesor
                </button>
