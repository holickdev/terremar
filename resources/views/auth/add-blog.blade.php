    ...
    <section class="p-4">
        ...
        class="relative mx-auto w-full overflow-hidden">
            ...
            <div class="grid mb-4">
                ...
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="picture">Imagen de Portada</label>
                <input
            ...
            <x-input-label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="body" :value="__('Article')" />
            ...
            <button type="submit" id="export"
                class="fixed bottom-4 right-4 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Enviar</button>
        </form>


    </section>
    <script type="module" src="{{ asset('js/custom/blog.js') }}"></script>
