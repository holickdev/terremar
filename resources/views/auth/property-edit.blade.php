...
@section('content')
    ...
    <form method="POST" action="{{ route('dashboard.property.update', $property->id) }}" enctype="multipart/form-data" x-data="{ step: 1 }"
        ...
        <div class="flex transition-transform duration-700" :style="`transform: translateX(${(step - 1) * -100}%);`">
            ...
            <div class="w-full p-4 flex-shrink-0">
                ...
                <div class="relative z-0 w-full mb-4 group">
                    ...
                    <x-input-error :messages="$errors->get('advisorIdentifications')" class="mt-2" />
                </div>
                ...
                <div class="relative z-0 w-full mb-4 group">
                    <input
                        ...
                        id="uploadMedia" name="uploadMedia[]" multiple accept="image/*,video/*" type="file">
                </div>
