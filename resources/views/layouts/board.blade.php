...
<body class="font-sans antialiased">
    <div class="min-h-screen bg-gray-100">
        ...
        <section>
            ...
            <aside id="logo-sidebar hover:bg-gray-100"
                    ...
                    <ul class="space-y-2 font-medium">
                        <li>
                            <a href="{{ route('index') }}"
                                ...
                                <i class="flex-shrink-0 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white
                                fa-solid fa-house"></i>
                        ...
                        <li>
                            <button type="button"
                                ...
                                <i class="flex-shrink-0 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white
                                fa-solid fa-square-plus fa-lg"></i>
                                <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Agregar</span>
                        ...
                        <li>
                            <a href="{{ route('advisors') }}"
                                ...
                                <i
                                    ...
                                    fa-solid fa-user-tie fa-lg"></i>
                                <span class="flex-1 ms-3 whitespace-nowrap">Asesores</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('owners') }}"
