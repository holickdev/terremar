...
@section('content')
    ...
    <div class="bg-gray-100">
                ...
                <div class="w-full md:w-1/2 px-4">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex space-x-2">
                            <ul class="tracking-normal mt-1 text-sm text-gray-500 w-full flex justify-between">
                                <li class="inline-flex justify-between"><i class="mr-2 text-lg fa-solid fa-bed"></i>
                                    <p>{{ $property->bedrooms }}</p>
                                </li>
                                <li class="inline-flex justify-between"><i class="mr-2 text-lg fa-solid fa-shower"></i>
                                    <p>{{ $property->bathrooms }}</p>
                                </li>
                                <li class="inline-flex justify-between"><i class="mr-2 text-lg fa-solid fa-car"></i>
                                    <p>{{ $property->parkings }}</p>
                                </li>
                                <li class="inline-flex justify-between"><i
                                        class="mr-2 text-lg fa-solid fa-ruler-combined"></i>
        ...
        <script>
            var map = L.map('map').setView([10.9837664, -63.8287713], 16); // Coordenadas centrales
            ...
            // Definir el polígono
            var sambilPolygon = [
                [10.998907, -63.793980], // Punto 1
                [10.998540, -63.793440], // Punto 2
                [10.998200, -63.793850], // Punto 3
                [10.998370, -63.794420], // Punto 4
                [10.998800, -63.794700], // Punto 5
                [10.998907, -63.793980] // Cierra el polígono
            ];

            // Agregar el polígono al mapa
            L.polygon(sambilPolygon, {
                    color: 'blue',
                    fillColor: '#3388ff',
                    fillOpacity: 0.5
                }).addTo(map)
                .bindPopup('Sambil Margarita');

            var circle = L.circle([10.9837664, -63.8287713], {
                color: 'red',
                fillColor: '#f03',
                fillOpacity: 0.5,
                radius: 10
